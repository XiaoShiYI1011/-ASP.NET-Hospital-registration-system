...
function($) {
	...
	function clearMenus(e) {
		...
		$(toggle).each(function() {
			...
			if (e && e.type == 'click' && /input|textarea/i.test(e.target.tagName) && $.contains($parent[0], e
					.target)) return
...
function($) {
	...
	Tooltip.prototype.init = function(type, element, options) {
		...
		this.$viewport = this.options.viewport && $(document).find($.isFunction(this.options.viewport) ? this
	...
	Tooltip.prototype.show = function() {
		...
		if (this.hasContent() && this.enabled) {
			...
			this.options.container ? $tip.appendTo($(document).find(this.options.container)) : $tip.insertAfter(this
				.$element)
...
function($) {
	...
	var Affix = function(element, options) {
		...
		var target = this.options.target === Affix.DEFAULTS.target ? $(this.options.target) : $(document).find(this
			.options.target)
