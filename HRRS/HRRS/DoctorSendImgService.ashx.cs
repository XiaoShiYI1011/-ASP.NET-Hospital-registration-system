...
{
    /// <summary>
    /// DoctorSendImgService 医生发送图片的一般处理程序
    /// </summary>
    public class DoctorSendImgService : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (resault)
            {
                ...
                if (OnlineInquiryManager.DoctorMessageImgInsertManager(userID, doctorID, saveDataPath))
                {
